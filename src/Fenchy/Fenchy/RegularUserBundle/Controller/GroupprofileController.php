...
class GroupprofileController extends Controller
{
        ...
        public function joinClosedGroupRequestAction()
	{
		...
		$noticerequest->setText($this->get('translator')->trans('regularuser.add_me_in_your_neighbor'). " " .$targetUserGroup->getGroupname()." ".$this->get('translator')->trans('regularuser.to_your_neighborlist'));
