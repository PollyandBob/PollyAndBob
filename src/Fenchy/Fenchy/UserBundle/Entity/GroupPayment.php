...
/**
 * @ORM\Table(name="grouppayment__setting")
 * @ORM\Entity(repositoryClass="Fenchy\UserBundle\Entity\GroupPaymentRepository")
 *
 */
class GroupPayment
{
	...
	/**
	 * @var User $group;
	 * @ORM\OneToOne(targetEntity="Fenchy\RegularUserBundle\Entity\UserGroup", inversedBy="payment_id")
	 */
	private $group;
