...
(function($){
	...
	$.jWindowCrop = function(image, options){
		...
		base.init = function(){
			...
			base.$frame.append('<div class="jwc_controls" style="position:relative;display:'+(base.options.showControlsOnStart ? 'block' : 'none')+';"><span class="dragger">drag to reposition</span></div>');
