...
var geoFormId = 'fenchy_regularuserbundle_usergroup_locationtype_location';
...
function fillLocationField(object) {
    ...
    $('#fenchy_regularuserbundle_usergroup_locationtype_location_location').val(address);
...
function setLocation(new_address) {
    ...
    if($('#fenchy_regularuserbundle_usergroup_locationtype_location_location').is('input')) {
        address = $('#fenchy_regularuserbundle_usergroup_locationtype_location_location').val();
        if(address.length) {
            isPlace     = true;
        }
    }
